...
class Settings(BaseSettings):
    ...
    # ===== CORS =====
    cors_allowed_origins: str = "http://localhost:3000,https://aps-bbc-02-dhdqd5eqgxa7f0hg.canadacentral-01.azurewebsites.net,http://localhost:3001,http://127.0.0.1:3000"
